...
<div class="lais-sidebar-inner">
    ...
    <div class="lais-nav-section">
        ...
        <a class="lais-nav-link {{ request()->routeIs('dashboard') || request()->routeIs('*.dashboard') ? 'active' : '' }}"
    ...
    @if ($isEmployee)
        <div class="lais-nav-section">
            ...
            <a class="lais-nav-link {{ $active('employee.leaves.create') }}"
    ...
    @if ($isApprover)
        <div class="lais-nav-section">
            ...
            <a class="lais-nav-link {{ $active('approver.reports.myActions') }}"
                href="{{ route('approver.reports.myActions') }}">
    ...
    @if ($isOfficeAdmin)
        <div class="lais-nav-section">
            ...
            <a class="lais-nav-link {{ $active('admin.employees.index') }}"
            ...
            <a class="lais-nav-link {{ $active('admin.approvalSteps.index') }}"
    ...
    @if ($isSuper)
        <div class="lais-nav-section">
            ...
            <a class="lais-nav-link {{ $active('super.divisions.index') }}"
                href="{{ route('super.divisions.index') }}">
